    ...
    <div className="layout-container flex h-full grow flex-col">
      <header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-b-[#283039] px-10 py-3">
        ...
        <div className="flex flex-1 justify-end gap-8">
          ...
          <Button className="min-w-[84px] max-w-[480px] h-10 px-4 bg-[#0c7ff2] text-white text-sm font-bold leading-normal tracking-[0.015em]">
            ...
            <div className="flex flex-col justify-end gap-6 px-4 py-10">
              ...
              <div className="flex flex-1 justify-center">
                <div className="flex justify-center">
                  <Button className="min-w-[84px] max-w-[480px] h-10 px-4 bg-[#0c7ff2] text-white text-sm font-bold leading-normal tracking-[0.015em] grow">
                    <span className="truncate">Start Generating</span>
                  </Button>
                </div>
              </div>
